...
<html lang="en">
   <head>
      ...
      <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v13.0&appId=366734541945089&autoLogAppEvents=1" nonce="IWul3iip"></script>
   </head>
   <body>
      <!-- LOADER -->
      <div id="fb-root"></div>
      ...
      <header>
         <div class="sticky">
            <div class="container">
               <!-- Logo -->
               <div class="logo"> <a class="logo-1" href="{{URL::to('/trang-chu')}}"><img src="{{asset('public/frontend/images/logo.png')}}" alt=""></a> </div>
               <nav class="navbar ownmenu">
                  <div class="navbar-header">
                     <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#nav-open-btn" aria-expanded="false"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar" style="color: #000;"><i class="fa fa-navicon"></i></span> </button>
                  </div>
                  <!-- NAV -->
                  <div class="collapse navbar-collapse" id="nav-open-btn">
                     <ul class="nav">
                        ...
                        <li><a href="{{URL::to('/sponsor')}}">Tài trợ</a> </li>
                        <li><a href="{{URL::to('course')}}">Khóa học</a> </li>
                        <li><a href="{{URL::to('/activity')}}">Hoạt động</a> </li>

                        <li><a href="{{URL::to('/map')}}">Địa chỉ</a> </li>
      ...
      <footer>
         <div class="container">
            ...
            <div class="col-md-3" style="color: white;">
               TAEKWONDO
               <div class="fb-page" data-href="https://www.facebook.com/hanuldanangclub/" data-tabs="events" data-width="" data-height="" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="false"><blockquote cite="https://www.facebook.com/hanuldanangclub/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/hanuldanangclub/">Câu lạc bộ Taekwondo HANUL Đà Nẵng</a></blockquote></div>
            </div>

            <!-- Rights -->
            <div class="rights">
               <p>©  2022 Loeii All right reserved. </p>
            </div>
         </div>
      </footer>
      <!--======= RIGHTS =========-->
